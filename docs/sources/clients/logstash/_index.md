...
You can use the [`values.yaml`](https://github.com/MarkWang2/BlugeLoki/blob/master/production/helm/loki-stack/values.yaml) file as a starting point for your own configuration.
