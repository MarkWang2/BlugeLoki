...
To do so you can use our [Fluent Bit helm chart](https://github.com/MarkWang2/BlugeLoki/tree/master/production/helm/fluent-bit):
...
First you need to follow those [instructions](https://github.com/MarkWang2/BlugeLoki/blob/master/cmd/fluent-bit/README) to build the plugin dynamic library.
...
A full [example configuration file](https://github.com/MarkWang2/BlugeLoki/blob/master/cmd/fluent-bit/fluent-bit.conf) is also available in this repository.
