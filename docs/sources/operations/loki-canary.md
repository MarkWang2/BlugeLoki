...
[Loki Releases](https://github.com/MarkWang2/BlugeLoki/releases) on GitHub.
...
```shell
jb install github.com/MarkWang2/BlugeLoki-canary/production/ksonnet/loki-canary
```
...
$ git clone https://github.com/MarkWang2/BlugeLoki
